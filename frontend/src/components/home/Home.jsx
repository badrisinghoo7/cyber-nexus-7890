    ...
    <section id="home">
      <div className="banner">
        <div className="info__div">
          ...
          <p>
            StudyBuddy is more than flashcards: it’s the #1 global learning
            platform. Join our community of 300 million learners using
            StudyBuddy's practice tests, Expert Solutions and AI-powered tools
            to improve their grades and reach their goals.
          </p>
          <Link className="sign__btn" to="/signup">
            Sign up now
          </Link>
        </div>
      </div>
